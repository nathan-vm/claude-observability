...
func TestGeneratePlist_ContainsLabelAndEnv(t *testing.T) {
	cfg := Config{
		Label:      "com.claude-observability.dash-generator",
	...
	for _, want := range []string{
		"com.claude-observability.dash-generator",
...
func TestGeneratePlist_EscapesXML(t *testing.T) {
	cfg := Config{
		Label: "com.claude-observability.x", Command: "/bin/x", WorkingDir: "/repo", LogDir: "/repo/.state",
...
func TestGeneratePlist_IncludesArgs(t *testing.T) {
	cfg := Config{
		Label: "com.claude-observability.x", Command: "/bin/x", Args: []string{"--once"}, WorkingDir: "/repo", LogDir: "/repo/.state",
	}
	out := GeneratePlist(cfg)
